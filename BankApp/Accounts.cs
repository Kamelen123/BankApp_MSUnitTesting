...
namespace BankApp
{
    public class Accounts //We declare what a account is. An Account needs to have the properties listed below.
    {
        ...
        public static void OpenNewAccount(User loggedInUser)//Method to open a new account. 
        {
            ...
            // OBS!!!!!!!! added an empty string to correspond with the changes made to this method
            var input = new List<string> { };
            CurrencySelectionMenu(input, out currency, out currencySymbol);
        ...
        public static void OpenSavingsAccount(User loggedInUser)//Method to open a savings account
        {
            ...
            //CurrencySelectionMenu("", out currency, out currencySymbol); // OBS!!!!!!!! added an empty string to correspond with the changes made to this method
        ...
        //OBS added a String input for Testing the method
        public static void CurrencySelectionMenu(IEnumerable<string> currencySelections, out string currency, out string currencySymbol)
        {
            currency = "";
            currencySymbol = "";
            ...
            while (!validCurrency) // Will loop the switch case until criteria is met
            {
                ...
                foreach (var currencySelection in currencySelections)
                {
