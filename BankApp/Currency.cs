...
namespace BankApp
{
    public static class Currency //Here we declare the exchange rates for all of the conversions
    {
        private static double _usdEurCur = 0.94;
        private static double _usdKronorCur = 10.86;
        private static double _eurUsdCur = 1.08;
        ...
        public static bool IsValidBorrowAmount(double borrowAmount, double remainingBorrowLimit)
        {
            if (borrowAmount <= 0)
            {
